    ...
    <div class="color-picker flex items-center gap-2">
        ...
        <Popover :anchor="anchor" :open="open" :width="272" @close="open = false">
            <div class="space-y-3 p-3">
                ...
                <div class="flex items-center gap-2 border-t border-gray-200 pt-3 dark:border-white/10">
                    <OptionStrip
                    ...
                    <code class="ml-auto min-w-0 truncate font-mono text-xs text-gray-700 dark:text-gray-200">{{ display }}</code>
